...
## 10.<div id="id10">lastIndexOf()</div>
### 检测当前值在数组中最后一次出现的位置索引
### 返回值：最后一次查到的索引，未找到返回-1

## 11.<div id="id11">includes()</div>
### 判断一个数组是否包含一个指定的值
```
let ary11 = ['a','b','c','d']; 
